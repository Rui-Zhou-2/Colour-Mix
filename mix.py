...
from self_training.mean_teacher import EMATeacher
...
def main(args: argparse.Namespace):
    ...
    t_model = EMATeacher(model, alpha=args.alpha)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--resume", type=str, default='./back/logs/u1v2h/mix/ckp/best.pth',
