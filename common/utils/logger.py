...
class CompleteLogger:
    ...
    def __init__(self, root, phase='train'):
        self.root = root
        self.phase = phase
        self.visualize_directory = os.path.join(self.root, "vis")
        self.checkpoint_directory = os.path.join(self.root, "ckp")
        self.epoch = 0
        ...
        log_filename = os.path.join(self.root, "{}-{}.log".format(phase, now))
